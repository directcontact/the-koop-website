    ...
    return (
      <div>
        <div className="story__text u-margin-bottom-medium">
          ...
          UNIQUE BATTER MIX CREATE A BARRIER TO KEEP THE MEAT MOIST AND CRISPY
          OUT LOWER PRICES THAN COMPETITION: BRAND-NAME MEALS AT NO-FRILLS
          PRICES LARGER PORTIONS THAN THE COMPETITION
          <br />
          <br />
