...
class OrderingPage extends React.Component {
  ...
  renderLocationSelection() {
    ...
    return (
      <>
        <div className="row">
          <div className="ordering__container-header">PICK A LOCATION</div>
        </div>
        <div className="row">
                  ...
                  <div
                    ...
                    onClick={() =>
                      this.props.location === location.name
                        ...
                        : this.props.addLocation(location.name)
                    }
                  >
  ...
  saveChickenPrices(size) {
    ...
    if (
      (this.state.currentSel.item == 'Whole' && size == 'Small') ||
      (this.state.currentSel.item == 'Boneless' && size == 'Small')
    ) {
      price = 9.95;
    } else if (
      (this.state.currentSel.item == 'Whole' && size == 'Large') ||
      (this.state.currentSel.item == 'Boneless' && size == 'Large')
    ) {
      price = 18.95;
    } else if (
      (this.state.currentSel.item == 'Wings' && size == 'Small') ||
      (this.state.currentSel.item == 'Drumsticks' && size == 'Small')
    ) {
      price = 11.95;
    } else if (
      (this.state.currentSel.item == 'Wings' && size == 'Large') ||
    ...
    return (
      <>
        <div className="ordering__container-content">
              ...
              {chickenTypes.map((type) => {
                ...
                return (
                  <span
                    ...
                    onClick={() => this.renderChickenSizes(type)}
                  >
                    <span className="ordering__container-menuContent_text">
                      {type}
                    </span>
                  </span>
                );
          ...
          <div className="row">
            <div className="ordering__container-header">CHOOSE SIZE</div>
          </div>
              ...
              {sizes.map((size) => {
                ...
                return (
                  <span
                    ...
                    onClick={() => this.saveChickenPrices(size)}
                  >
                    <span className="ordering__container-menuContent_text">
                      {size}{' '}
                      {sizes.indexOf(size) === 0
                        ? this.state.chickenPrices[0]
                        : this.state.chickenPrices[1]}
                    </span>
                  </span>
                );
              })}
          ...
          <div className="row">
            <div className="ordering__container-header">CHOOSE SIDE</div>
          </div>
          ...
          <div className="row">
            <div className="ordering__container-header">CHOOSE SAUCE</div>
          </div>
                ...
                return (
                    ...
                    onClick={() =>
                      this.setState({
                        ...
                        currentSel: {
                          ...this.state.currentSel,
                          sauce:
                            this.state.currentSel.sauce === sauce.name
                              ? ''
                              : sauce.name,
                          active: 'selectedLocation',
                        },
                  ...
                  >
                    <div className="ordering__container-sauce_button_content">
                      <img
                        className="ordering__container-sauce_button_content--img"
                        src={sauce.src}
                      />
  ...
  renderMenuComponent(navActive) {
    switch (navActive.selection) {
      ...
      case 'SIDES':
        const sides = this.props.menu.items
          .filter((item) => item.type === 'side')
          .filter((item) => item.name !== 'kimchi')
          .filter((item) => item.name !== 'blue cheese / ranch');
  ...
  renderOrderComponent() {
    ...
    return (
      <>
        ...
        <div
          className="row ordering__cartbutton"
  ...
  renderPickUpForm() {
    ...
    return (
      <>
            ...
            <div className="ordering__form-left col-md-6">
              ...
              <div className="row">
                ...
                <div className="ordering__form-left_textarea">
                  <textarea
                    type="text"
                    placeholder="e.g., Extra napkins pls"
                    style={{ border: 0 }}
        ...
        <div className="ordering__form-extra">
          <br />
        ...
        <div className="ordering max-height col-md-12">
          <div className="ordering col-md-9">
            <div className="ordering__container">
              {this.renderSteps(this.state.navActive)}
            </div>
