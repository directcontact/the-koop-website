...
export default class LocationPage extends React.Component {
      ...
      <div className="location__greybg">
        <div className="location_text">
          ...
          <p>
            ...
            {location1.phone}
            <br />
            <strong>{location1.days[0]}</strong>npm ruun : {location1.hours[0]}{' '}
            <br />
  ...
  renderMapGrey() {
    return <div className="location__map-grey">MAP GOES HERE</div>;
  }

  renderMapWhite() {
    return <div className="location__map-white">MAP GOES HERE</div>;
  }
